...
def map_id_to_initial(employee_list):
   ...
   """
   ### WRITE SOLUTION CODE HERE
   #make 2 comprehensions with the targeted values
   ids = [emps["id"] for emps in employee_list]
   emp_names = [emps["name"][0] for emps in employee_list]

   the_dictionary = {key: value for key, value in zip(emp_names, ids)}
